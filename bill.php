...
<body>
  ...
  <div id = "heading">
    ...
    <h2>Your bill amount is <?php echo $_SESSION['price']?> x <?php echo $_SESSION['norm'] ?> x <?php echo $_SESSION['datediff'] ?> = <?php echo $_SESSION['price']*$_SESSION['norm']*$_SESSION['datediff'] ?></h2>
  <div>
